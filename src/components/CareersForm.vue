<template>
  <div id="form" class="bg-gray-100">
    <div class="mx-auto max-w-7xl py-8 px-4 sm:py-8 sm:px-6 lg:px-8">
      <div class="relative bg-white shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            ...
            <form @submit="submitForm" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              <div>
...
function submitForm() {
    fetch('https://vue-http-demo-5b34f-default-rtdb.firebaseio.com/applicants.json', {
    method: 'POST',
    headers: {
